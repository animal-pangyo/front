...
const Chat = () => {
    ...
    const { data: chatList, isLoading, isError } = useQuery('chatList', fetchChatList);
        ...
        <div className={styled.chatBox}>
            ...
            : 
                ...
                <div className={styled.chatList}>
                    {chatList && chatList.map((msgListItem) => (
                        <ChatListItem key={msgListItem.id} msgListItem={msgListItem} />
                    ))}
                </div>
